...
-- 1. Insert Categories
INSERT INTO public.categories (id, name, slug, image_url, description, created_at, updated_at) VALUES
...
INSERT INTO public.products (id, title, slug, is_published, subtitle, description, "basePrice", "categoryId", rating, reviews, features, benefits, "productDetails", created_at, updated_at) VALUES
...
INSERT INTO public.product_variants (id, "productId", name, sku, price, "originalPrice", sizes, "imagePath", "galleryPaths", stock, "isAvailable", "sortOrder", created_at, updated_at) VALUES
