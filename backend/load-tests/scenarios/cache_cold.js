// CACHE COLD TEST: Low cache hit rate scenario
// ENABLE_RESPONSE_CACHE=true, random pages 1-1000
// This simulates production with diverse page access patterns
...
export default function () {
  // Random pages 1-1000 to force low cache hit rate
  // With 100 max cache entries, hit rate should be < 20%
...
export function handleSummary(data) {
  ...
  console.log('Random pages: 1-1000');
