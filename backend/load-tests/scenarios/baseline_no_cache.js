// BASELINE TEST: Cache completely disabled
// ENABLE_RESPONSE_CACHE=false, random pages 1-100
// This measures performance WITHOUT any cache benefit
...
export default function () {
  // Random pages 1-100 to ensure varied requests
...
export function handleSummary(data) {
  ...
  console.log('ENABLE_RESPONSE_CACHE=false');
  console.log('Random pages: 1-100');
